...
usedTotalForceVector = zeros(3,size(this.FlightControl.Alphas, 2),...
...
if norm(this.controlVector(:,this.FlightControl.SatID))==0
  ...
  [this.forceVector, alphaOpt, betaOpt, gammaOpt] =...
        this.FlightControl.findBestAttitude(usedTotalForceVector,this.controlVector(:,this.FlightControl.SatID),...
