...
parametersCLUSTER = struct(   ... 
  ...
  'FolderFFPS'      , 'ffps', ...
    'FFPS'          , [struct('ffp1',0,...
                              ...
                              'ffp7',0,...
                              'ffp8',0)
                       struct('ffp1',50,...%% normally 100
                              'ffp2',-115,...
                              'ffp3',50,...%% normally 100
                              'ffp4',0,...
                              'ffp5',0,...
                              'ffp6',0,...
                              'ffp7',0,...
...
%sim = CosmosSimulation(parametersIvanov,iniConditionsIvanov);
sim = CosmosSimulation(parametersCLUSTER,iniConditionsCLUSTER);
%sim = CosmosSimulation(parametersISMission,iniConditionsISMission);
...
%% Plot and visulize results
%! this should go to sim.start
sim.plotting(sim.NumSatellites, orbit(1).MeanMotionRad);
sim.visualizationLONLATALT(sim.NumSatellites,orbit(1).Altitude)
